...
%Calculate Hilbert-Energy-Spectrum(NNSPE.m)
     ...
     figure(2);
     imagesc(tae,fae,nte);axis xy;set(gca,'FontSize',6);title('Hilbert Energy Spectrum- for EEMD','FontSize',9);xlabel('Time(sec)','FontSize',7,'VerticalAlignment','middle');ylabel('Freq(hz)','FontSize',7);
